  ...
  Widget content() {
    return Column(
      children: [
        ...
        Container(
          child: TableCalendar(
            daysOfWeekStyle: DaysOfWeekStyle(weekdayStyle: TextStyle(color: Colors.red,fontWeight:FontWeight.bold ),
        weekendStyle: TextStyle(color: Colors.red,fontWeight:FontWeight.bold),
            ...
            calendarStyle:  CalendarStyle(
             ...
             outsideTextStyle:  TextStyle(color: Color.fromARGB(255, 51, 170, 40)),
        ...
        style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20,color: Color(0xFFEB5757)),
       ),
      ],
    );
  }
